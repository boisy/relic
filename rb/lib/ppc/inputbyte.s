...
; get path in r3
tryagain:
        addis r3,0,ha16(inputbyte_p0)
        lbz  r3,lo16(inputbyte_p0)(r3)

; get address in r4
        addis r4,0,ha16(inputbyte_p1)
        ori  r4,r4,lo16(inputbyte_p1)
...
; call to convert
        addis r3,0,ha16(inputbyte_p1)
        ori  r3,r3,lo16(inputbyte_p1)
        bl   StrToDecU8
        cmpi 0,0,r3,0
        beq  saveit
        bl   RedoInput
