...
# get path in r3
tryagain:
        addis r3,0,inputbyte_p0@ha
        lbz  r3,inputbyte_p0@l(r3)

# get address in r4
        addis r4,0,inputbyte_p1@ha
        ori  r4,r4,inputbyte_p1@l
...
# call to convert
        addis r3,0,inputbyte_p1@ha
        ori  r3,r3,inputbyte_p1@l
        bl   StrToDecU8
        cmpi 0,0,r3,0
        beq  saveit
        bl   RedoInput
