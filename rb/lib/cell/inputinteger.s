...
# get path in r3
tryagain:
        addis r3,0,inputinteger_p0@ha
        lbz  r3,inputinteger_p0@l(r3)

# get address in r4
        addis r4,0,inputinteger_p1@ha
        ori  r4,r4,inputinteger_p1@l
...
# call to convert
        addis r3,0,inputinteger_p1@ha
        ori  r3,r3,inputinteger_p1@l
        bl   StrToDecS16
        cmpi 0,0,r3,0
        beq  saveit
        bl   RedoInput
